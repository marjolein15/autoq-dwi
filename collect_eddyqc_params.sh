...
#${subject}.eddy_parameters = trans_x trans_y trans_z rot_x rot_y rot_z ec_x ec_y ec_z ec_quad[xyz] ec_mult[xyx]
...
#tSNR
fslmaths ${subject}_unwarped_b0s -Tmean ${subject}_b0_mean
bet ${subject}_b0_mean ${subject}_b0_brain -m -f 0.3
fslmaths ${subject}_unwarped_b0s.nii.gz -mas ${subject}_b0_brain_mask.nii.gz -Tstd ${subject}_b0_std.nii.gz 
